        ...
        <section id="contact" className="py-24 bg-slate-950 relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                >
                    ...
                    <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold font-['Outfit'] text-white mt-2 mb-6">
                        Let's Create{' '}
                ...
                <div className="max-w-5xl mx-auto">
                    ...
                    >
                        <a
                            ...
                            className="group block p-8 sm:p-12 rounded-2xl bg-gradient-to-br from-emerald-500/10 to-amber-500/10 border-2 border-emerald-500/20 hover:border-emerald-500/40 transition-all duration-300 hover:shadow-2xl hover:shadow-emerald-500/10"
                        >
                            <div className="flex items-center justify-between flex-wrap gap-6">
                                <div className="flex items-center gap-6">
                                    <div className="p-4 rounded-xl bg-emerald-500/10 text-emerald-400 group-hover:bg-emerald-500/20 transition-colors">
                                        <Mail className="w-8 h-8" />
                                    </div>
                                    <div>
                                        <p className="text-sm text-slate-500 font-medium uppercase tracking-wider mb-1">Email Me</p>
                                        <p className="text-2xl sm:text-3xl font-bold text-white font-['Outfit'] group-hover:text-emerald-400 transition-colors">
